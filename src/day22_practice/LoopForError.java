...
public class LoopForError {
	public static void main(String[] args) {
		...
		int count = 0;
		for (int i = 0; i <= log.length() - 5; i++) {  //5 is the number of the character within error
		...
		//Count: 3
				System.out.println("Number of (error) in the log: " + count);
				
				if(count > 0) {
					System.out.println("Number of Error is more than zero: FAIL");
				}else {
					System.out.println("No Error found: PASS");
				}
