...
public class CopyOf2 {
	public static void main(String[] args) {
		...
		int[] nums4= Arrays.copyOfRange(nums3, 1 , 3);
		System.out.println(Arrays.toString(nums4));//[34, 56, 23]
		System.out.println(Arrays.toString(nums2));  //[34, 56, 23, 1, 55, 0, 0]
		...
		brandNew = Arrays.copyOf(brandNew, 1);
		System.out.println("Test: " + Arrays.toString(brandNew));
